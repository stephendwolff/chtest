...
var addr = flag.String("addr", "sportable.maxgatedigital.com:8080", "http service address")
...
func chtest(w http.ResponseWriter, r *http.Request) {
	...
	for {
		...
		*/
		...
		var timestampStr = message.UUID[:8]  //strconv.FormatInt(message.TimeStamp, 16)
		var deviceIDStr = message.UUID[8:]  //join(UUIDpart1, deviceID[2:])
...
//		log.Printf("recv: %s", message.UUID)
